...
from ui_langchain.utils import extract_content_from_chunk, extract_sql_from_content, extract_todos
from agents.agent import stream_agent
...
def handle_chat_input():
    ...
    if prompt := st.chat_input("💬 Ask question (e.g., 'employees in Sales')", key="lc_chat_input"):
        prompt = prompt.strip()
        if not prompt: 
            st.rerun()
